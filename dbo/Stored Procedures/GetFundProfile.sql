...
AS
    BEGIN
        ...
        INSERT INTO @tblMCT
               ...
               WHERE companyname LIKE 'SC TKAP';
        ...
        IF(ISNULL(@LPShare, 0) + ISNULL(@GPShare, 0)) > 0
            SET @PICC = @CallsAB / (ISNULL(@LPShare, 0) + ISNULL(@GPShare, 0));
