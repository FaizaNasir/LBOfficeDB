CREATE PROCEDURE [dbo].[proc_PortfolioPerformanceForeignCurrencyGet_V1] @portfolioID  INT      = NULL, 
                                                                        @targetID     INT, 
                                                                        @targetTypeID INT, 
                                                                        @teamMemberID INT, 
                                                                        @date         DATETIME
    ...
    BEGIN
        ...
        (
            SELECT ShareholdingOperationID, 
                   Date, 
                   -1 * ISNULL(foreigncurrencyamount, s.Amount) Amount, 
            ...
            SELECT OperationID, 
                   date, 
                   -1 * ISNULL(foreigncurrencyamount, s.Amount), 
                   'GeneralOperation', 
                   TypeID, 
                   ToModuleID, 
                   FromModuleID, 
