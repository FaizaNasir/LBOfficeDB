...
--  select dbo.[F_CapitalTable_NonDiluted_test]('31 Dec,2015',1,574,28,3)    

CREATE FUNCTION [dbo].[F_CapitalTable_NonDiluted]
(@date              DATETIME, 
 @portfolioid       INT, 
...
AS
     BEGIN
         DECLARE @nondiluted AS DECIMAL(18, 4);
